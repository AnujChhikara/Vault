...
import { ChevronFirst, Github, Loader2, Mail } from "lucide-react";
...
export default function SignInForm() {
  ...
  return (
    <div className='flex flex-col justify-center items-center sm:px-4 md:px-0 min-h-screen bg-black/[0.96]'>

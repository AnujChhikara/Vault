...
useEffect(() => {
  ...
  const onSubmit = async(data:z.infer<typeof signUpSchema>) =>{
    ...
    console.log(data) //TODO: remove it after checking

    try {
     const response = await axios.post('/api/sign-up', data)
     console.log(response) //TODO: remove after checking
     toast({
      title:'Success',
  ...
  return (
   <div className="flex justify-center items-center min-h-screen bg-black/[0.96]">
      <div className="w-full max-w-md p-8 space-y-8 bg-transparent text-white border border-zinc-800 rounded-lg shadow-md">
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight lg:text-5xl mb-6">
            Welcome to DevVault!
          </h1>
          <p className="mb-4 font-bold tracking-tight text-zinc-400">Start Organizing Your Code Journey - Sign Up Now!</p>
        </div>
        <Form {...form}>
